...
import ecjtunet.com.demon.view.articleView;


public class newscontent extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleView = (ecjtunet.com.demon.view.articleView) findViewById(R.id.news_article);
...
//        actionBar.setTitle(title);
    ...
    private class getConent extends Thread {
        ...
        public void run() {
            ...
            hashMap = httpHelper.getNewsContent(articleID);
